      	...
      	//array of directory menu items
       	...
       	'activity' => array( 'title' => 'Activity',
				...
				'all-activity' => array( 'title' => 'All Activity',
							             'class' => 'bp-menu-main-item',
							             'component' => 'activity',
							             'xfn'   => 'bp-user-directory-all-activity'
							),
				'my-friends-activity'  => array( 'title' => 'My Friends',
							             'class' => 'bp-menu-main-item',
							             'component' => 'activity',
							             'xfn'   => 'bp-user-directory-my-friends-activity'
							),
				'my-groups-activity'  => array( 'title' => 'My Groups',
							             'class' => 'bp-menu-main-item',
							             'component' => 'activity',
							             'xfn'   => 'bp-user-directory-my-groups-activity'
							),         											
				'my-favorites-activity'  => array( 'title' => 'My Favorites',
							             'class' => 'bp-menu-main-item',
							             'component' => 'activity',
							             'xfn'   => 'bp-user-directory-my-favorites-activity'
							),
				'my-mentions-activity'  => array( 'title' => 'My Mentions',
							             'class' => 'bp-menu-main-item',
							             'component' => 'activity',
							             'xfn'   => 'bp-user-directory-my-mentions-activity'
							),         											
    ...
    <p>Plugin menu items will come in a future update</p>
      ...
      <p class="button-controls" >
           <span class="add-to-menu" >
           	...
           	<img class="waiting" style="display:none" src="<?php echo site_url(); ?>/wp-admin/images/wpspin_light.gif" alt="">
